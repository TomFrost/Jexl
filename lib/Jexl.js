 ...
 * Also clears the parser cache as the grammar is modified.
...
/**
 * Sets a cache entry for an expression tree generated by `Parser.complete`.
 * @param {string} exp The Jexl expression acting as a cache key.
 * @param {{}} expressionTree
 * @private
 */
Jexl.prototype._setParserCache = function(exp, expressionTree) {
  this._parserCache[exp] = expressionTree;
};

/**
 * Gets a cached expression tree for a given Jexl expression.
 * Returns null if there's no entry in cache.
 * @param {string} exp The Jexl expression acting as a cache key.
 * @returns {{}|null} the cached expression tree.
 * @private
 */
Jexl.prototype._getParserCache = function(exp) {
  return this._parserCache[exp] || null;
};
 ...
 * @private
 */
Jexl.prototype._clearParserCache = function() {
  this._parserCache = {};
};
