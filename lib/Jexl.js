...
Jexl.prototype.eval = function(expression, context, cb) {
	return this._run(this.compile.bind(this, expression), false, context, cb);
};
...
Jexl.prototype.compile = function(exp) {
	var compiledFn = this._compile(exp.trim());
	return this._run.bind(this, compiledFn, true);
};

Jexl.prototype._run = function(compileFn, isCompiled, context, cb) {
	var contextEval;
	...
	return Promise.resolve().then(function() {
		if (!contextEval)
			contextEval = isCompiled ? compileFn : compileFn();
