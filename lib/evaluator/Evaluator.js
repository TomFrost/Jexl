...
var Evaluator = function(grammar, transforms, context, relativeContext, deferred) {
	...
	this._deferred = deferred || this._genDeferred();
};

Evaluator.prototype._genDeferred = function() {
	var deferred = {};
...
Evaluator.prototype.evalLines = function(lines) {
	var results = this.evalArray(lines);
