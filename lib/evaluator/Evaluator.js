...
/**
 * Applies a collect subexpression to the values of a subject. Within the
 ...
 * string key otherwise, and the '~' identifier indicates that no result should
...
Evaluator.prototype._collect = function(subject, expr) {
	...
	return Promise.all(promises).then(function(tuples) {
		...
		return isObject ? results : results[0];
	});
};
