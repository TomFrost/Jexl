 ...
 * @constructor
 */
var Evaluator = function(grammar, transforms, context, relativeContext, extantLines) {
	this._grammar = grammar;
	this._transforms = transforms || {};
	this._context = context || {};
	this._relContext = relativeContext || this._context;
	this._extantLines = extantLines || [];
};
 ...
 * @returns {Promise<*>} resolves with the resulting value of the expression.
 */
Evaluator.prototype.evalLine = function(ast) {
	var extantLines = this._extantLines,
		ix = extantLines.length;
	extantLines.push(ix);
	var promise = this.eval(ast);
	promise.then(function () {
		extantLines.splice(extantLines.indexOf(ix), 1);
	});
	return promise;
};
...
Evaluator.prototype._filterRelative = function(subject, expr) {
	...
	subject.forEach(function(elem) {
		var evalInst = new Evaluator(this._grammar, this._transforms,
			this._context, elem, self._extantLines);
