...
exports.AssignmentExpression = function(ast) {
	...
	return this.eval(ast.subject).then(function(subject) {
		self._context[ast.name] = subject;
	});
};

exports.EvaluateLine = function (ast) {
	var self = this;
	return this.eval(ast.line);
}
...
exports.ShoveContextAssignment = function(ast) {
	var self = this;
	return this.eval(ast.subject).then(function(subject) {
		self._context[ast.name] = subject;
	});
...
exports.PassContext = function(ast) {
	var self = this;
	return this.eval(ast.subject).then(function() {
