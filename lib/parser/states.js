...
exports.states = {
	expectOperand: {
		tokenTypes: {
			...
			rightArrow: {toState: 'lambdaExpressionEnd', handler: h.lambdaExpressionStart},
	...
	lambdaExpressionEnd: {
		subHandler: h.lambdaExpressionEnd,
		completable: true
	},
	expectBinOp: {
		tokenTypes: {
			binaryOp: {toState: 'expectOperand'},
			shove: {toState: 'expectShoveContextAssignment'},
	...
	expectShoveContextAssignment: {
		tokenTypes: {
			identifier: {toState: 'postShoveContextAssignment', handler: h.shoveContextAssignment}
		}
	},
	expectTransform: {
		tokenTypes: {
	...
	postShoveContextAssignment: {
		tokenTypes: {
			semicolon: {toState: 'potentialOperand', handler: h.passContext},
		},
		completable: true
	},
	postTransformArgs: {
	...
	identifier: {
		tokenTypes: {
			binaryOp: {toState: 'expectOperand'},
			comma: {toState: 'expectOperand'},
			dot: {toState: 'traverse'},
			openBracket: {toState: 'filter'},
			pull: {toState: 'pullContextAssignmentEnd', handler: h.pullContextAssignmentStart},
			shove: {toState: 'expectShoveContextAssignment'},
			pipe: {toState: 'expectTransform'},
			question: {toState: 'ternaryMid', handler: h.ternaryStart}
		},
	...
	pullContextAssignmentEnd: {
		subHandler: h.pullContextAssignmentEnd,
		endStates: {
			semicolon: 'potentialOperand'
		},
		completable: true
	},
	subExpression: {
