...
exports.states = {
	expectFirstOperand: {
		tokenTypes: {
			...
			identifier: {toState: 'firstIdentifier'},
			unaryOp: {},
	...
	firstIdentifier: {
		tokenTypes: {
			binaryOp: {toState: 'expectOperand'},
			comma: {toState: 'expectIdentifier'},
			dot: {toState: 'traverse'},
			openBracket: {toState: 'filter'},
			assign: {toState: 'assignmentEnd'},
			turnstile: {toState: 'transformCreationEnd'},
			pipe: {toState: 'expectTransform'},
			question: {toState: 'ternaryMid', handler: h.ternaryStart}
		},
		completable: true
	...
	expectIdentifier: {
		tokenTypes: {
			identifier: {toState: 'expectComma'}
		}
	},
	identifier: {
		tokenTypes: {
	...
	transformCreationEnd: {
		subHandler: h.transformCreationEnd,
		appearsAs: {
			atSymbol: 'identifier'
		},
		completable: true
