...
exports.states = {
	...
	expectTransformAssignment: {
		tokenTypes: {
			turnstile: {toState: 'expectOperand', handler: h.transformAssignment}
		}
	},
	expectObjKey: {
		tokenTypes: {
	...
	firstIdentifier: {
		tokenTypes: {
			...
			pipe: {toState: 'expectTransform'},
			identifier: {toState: 'identifier'},
			openParen: {toState: 'transformAssignment'},
			turnstile: {toState: 'expectOperand', handler: h.transformAssignment},
			question: {toState: 'ternaryMid', handler: h.ternaryStart}
		},
		completable: true
	...
	collect: {
		subHandler: h.collect,
		endStates: {
			closeCollect: 'identifier'
		}
	},
	assignmentEnd: {
	...
	transformAssignment: {
		subHandler: h.transformAssignment,
		endStates: {
