...
/**
 * Handles assignment of an a named attribute to a context by encapsulating
 * the entire AST in a AssignmentExpression node before the cursor with the name of the token.
 * @param {{type: <string>}} ast The subexpression tree
 * @private
 */
...
exports.lambdaExpressionStart = function() {
	...
	while (ref && ref.value) {
		...
		ref = ref.right ? ref.right : undefined;
	}
	this._tree = {
