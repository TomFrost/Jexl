...
Parser.prototype.addToken = function(token) {
	...
	if (state.subHandler) {
		...
		if (stopState) {
			...
			this.incompletable = !!this._cursor._incompletable;
			if (this._parentStop)
				return stopState;
...
Parser.prototype.complete = function() {
	if (this._cursor && (!states[this._state].completable || this._cursor._incompletable))
 ...
 *      the expression, indicating that the expression is incomplete
 */
Parser.prototype._complete = function() {
	if (this._subParser)
		this._endSubExpression();
 ...
 * @private
 */
Parser.prototype._throwTokenError = function(token) {
