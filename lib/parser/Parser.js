 ...
 *      token type is encountered with a zero balance, the parser will be
 *      automatically marked complete.
 * @constructor
 */
function Parser(prefix, stopMap) {
 ...
 *      in the stopState map with a truthy value; false if tokens can continue.
 */
...
Parser.prototype._startSubExpression = function(exprStr) {
	...
	this._subParser = new Parser(exprStr, endStates);
};
