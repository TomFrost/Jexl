 ...
 * @private
 */
Evaluator.prototype._evalArrayLiteral = function(ast) {
 ...
 * alternate branch if it is not.
 * @param {{type: 'ConditionalExpression', test: {}, consequent: {},
 *      alternate: {}}} ast An expression tree with a ConditionalExpression as
 *      the top node
 * @private
 */
Evaluator.prototype._evalConditionalExpression = function(ast) {
	var self = this;
 ...
 * @private
 */
Evaluator.prototype._evalObjectLiteral = function(ast) {
